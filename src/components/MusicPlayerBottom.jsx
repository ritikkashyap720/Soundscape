    ...
    if (song) {
        return (
            <div className={`${isExpanded ? "h-full" : "h-[80px] bottom-0 "} fixed  z-30 transition-all w-full duration-[300ms] `}>
                ...
                {isExpanded && <div  className='w-full lg:h-screen h-[100%] fixed bottom-0 z-30 flex flex-row'>
                ...
                {!isExpanded && <div onClick={() => { setIsExpended(true); navigate("#player") }} className='flex items-center p-4 bg-[#001919] shadow-md border-t-[1px] h-[81px] border-green-300 w-full z-30 text-white justify-between gap-2'>
